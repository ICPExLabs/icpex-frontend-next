...
export const MILLISECONDS = 1000; // seconds
export const MILLISECONDS_MINUTE = MILLISECONDS * 60; // minutes
export const MILLISECONDS_HOUR = MILLISECONDS_MINUTE * 60; // hours
export const MILLISECONDS_DAY = MILLISECONDS_HOUR * 24; // days
export const MILLISECONDS_WEEK = MILLISECONDS_DAY * 7; // weeks
export const MILLISECONDS_MONTH = MILLISECONDS_DAY * 30; // months
export const MILLISECONDS_YEAR = MILLISECONDS_DAY * 365; // years
