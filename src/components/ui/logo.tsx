...
const LOGO_RECORD: Record<string, string> = {
    'ryjl3-tyaaa-aaaaa-aaaba-cai': TOKEN_IC_ICP_SVG,
    // CK
    'mxzaz-hqaaa-aaaar-qaada-cai': TOKEN_IC_CK_BTC_SVG,
    'cngnf-vqaaa-aaaar-qag4q-cai': TOKEN_IC_CK_USDT_SVG,
    'xevnm-gaaaa-aaaar-qafnq-cai': TOKEN_IC_CK_USDC_SVG,
    'ss2fx-dyaaa-aaaar-qacoq-cai': TOKEN_IC_CK_ETH_SVG,
    'g4tto-rqaaa-aaaar-qageq-cai': TOKEN_IC_CK_LINK_SVG,
    'ebo5g-cyaaa-aaaar-qagla-cai': TOKEN_IC_CK_OCT_SVG,
    'etik7-oiaaa-aaaar-qagia-cai': TOKEN_IC_CK_PEPE_SVG,
    'pe5t5-diaaa-aaaar-qahwa-cai': TOKEN_IC_CK_EURC_SVG,
    'fxffn-xiaaa-aaaar-qagoa-cai': TOKEN_IC_CK_SHIB_SVG,
    'nza5v-qaaaa-aaaar-qahzq-cai': TOKEN_IC_CK_XAUT_SVG,
    'j2tuh-yqaaa-aaaar-qahcq-cai': TOKEN_IC_CK_WSTETH_SVG,
    'ilzky-ayaaa-aaaar-qahha-cai': TOKEN_IC_CK_UNI_SVG,
    'bptq2-faaaa-aaaar-qagxq-cai': TOKEN_IC_CK_WBTC_SVG,
    // SNS
    '2ouva-viaaa-aaaaq-aaamq-cai': TOKEN_IC_SNS_CHAT_PNG,
    '73mez-iiaaa-aaaaq-aaasq-cai': TOKEN_IC_SNS_KINIC_PNG,
    '6rdgd-kyaaa-aaaaq-aaavq-cai': TOKEN_IC_SNS_DOLR_PNG,
    '4c4fd-caaaa-aaaaq-aaa3a-cai': TOKEN_IC_SNS_GHOST_PNG,
    'xsi2v-cyaaa-aaaaq-aabfq-cai': TOKEN_IC_SNS_DCD_PNG,
    'uf2wh-taaaa-aaaaq-aabna-cai': TOKEN_IC_SNS_CTZ_PNG,
    'vtrom-gqaaa-aaaaq-aabia-cai': TOKEN_IC_SNS_BOOM_PNG,
    'rffwt-piaaa-aaaaq-aabqq-cai': TOKEN_IC_SNS_SEER_PNG,
    'rxdbk-dyaaa-aaaaq-aabtq-cai': TOKEN_IC_SNS_NUA_PNG,
    'qbizb-wiaaa-aaaaq-aabwq-cai': TOKEN_IC_SNS_SONIC_PNG,
    'tyyy3-4aaaa-aaaaq-aab7a-cai': TOKEN_IC_SNS_GOLDAO_PNG,
    'emww2-4yaaa-aaaaq-aacbq-cai': TOKEN_IC_SNS_TRAX_PNG,
    'f54if-eqaaa-aaaaq-aacea-cai': TOKEN_IC_SNS_NTN_PNG,
    'hvgxa-wqaaa-aaaaq-aacia-cai': TOKEN_IC_SNS_SNEED_PNG,
    'hhaaz-2aaaa-aaaaq-aacla-cai': TOKEN_IC_SNS_ICL_PNG,
    'gemj7-oyaaa-aaaaq-aacnq-cai': TOKEN_IC_SNS_ELNA_PNG,
    'ddsp7-7iaaa-aaaaq-aacqq-cai': TOKEN_IC_SNS_FPL_PNG,
    'druyg-tyaaa-aaaaq-aactq-cai': TOKEN_IC_SNS_PANDA_PNG,
    'ca6gz-lqaaa-aaaaq-aacwa-cai': TOKEN_IC_SNS_ICS_PNG,
    'atbfz-diaaa-aaaaq-aacyq-cai': TOKEN_IC_SNS_YUKU_PNG,
    'bliq2-niaaa-aaaaq-aac4q-cai': TOKEN_IC_SNS_EST_PNG,
    'k45jy-aiaaa-aaaaq-aadcq-cai': TOKEN_IC_SNS_MOTOKO_PNG,
    'lrtnw-paaaa-aaaaq-aadfa-cai': TOKEN_IC_SNS_CONF_PNG,
    'lkwrt-vyaaa-aaaaq-aadhq-cai': TOKEN_IC_SNS_OGY_PNG,
    'jcmow-hyaaa-aaaaq-aadlq-cai': TOKEN_IC_SNS_WTN_PNG,
    'itgqj-7qaaa-aaaaq-aadoa-cai': TOKEN_IC_SNS_____PNG,
    'np5km-uyaaa-aaaaq-aadrq-cai': TOKEN_IC_SNS_DOGMI_PNG,
    'm6xut-mqaaa-aaaaq-aadua-cai': TOKEN_IC_SNS_ICVC_PNG,
    'o7oak-iyaaa-aaaaq-aadzq-cai': TOKEN_IC_SNS_KONG_PNG,
    'o4zzi-qaaaa-aaaaq-aaeeq-cai': TOKEN_IC_SNS_WELL_PNG,
    'oj6if-riaaa-aaaaq-aaeha-cai': TOKEN_IC_SNS_ALICE_PNG,
    'mih44-vaaaa-aaaaq-aaekq-cai': TOKEN_IC_SNS_NFIDW_PNG,
